...
namespace ReInvented.Geometry.Models
{
    ...
    public class Polygon
    {
        ...
        public List<Point3D> ClosingLinePoints => GenerateClosingLinePoints();
        ...
        private List<Point3D> GenerateClosingLinePoints(double maxDimension = 5)
        {
            var closingLinePoints = new List<Point3D>();
