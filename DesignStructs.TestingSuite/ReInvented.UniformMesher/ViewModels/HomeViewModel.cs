...
namespace ReInvented.UniformMesher.ViewModels
{
    public class HomeViewModel : ValidatablePropertyStore
    {
        ...
        public Direction ProgressionDirection { get => Get<Direction>(); set => Set(value); }
        ...
        private void Initialize()
        {
            ...
            GetTopNodesCommand = new RelayCommand(OnGetTopNodes, true);
            GetBottomNodesCommand = new RelayCommand(OnGetBottomNodes, true);
            ...
            FormationDirection = Direction.Vertical;
        }
