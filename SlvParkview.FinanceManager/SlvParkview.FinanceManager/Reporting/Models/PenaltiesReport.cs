...
namespace SlvParkview.FinanceManager.Reporting.Models
{
    ...
    /// </summary>
    public class PenaltiesReport : Report, IReport
    {
        #region Private Fields

        private const string _fileName = "Penalties Summary";
        ...
        public PenaltiesReport(Block block, DateTime reportTill, OutstandingsFilter filter = OutstandingsFilter.All)
        {
            _block = block;
        ...
        {
            IDataSerializer<PenaltiesReport> serializer = new JsonDataSerializer<PenaltiesReport>();
